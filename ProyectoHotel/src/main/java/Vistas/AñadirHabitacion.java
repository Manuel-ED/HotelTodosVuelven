...
public class AñadirHabitacion extends javax.swing.JFrame {
    ...
    if (numero < 101 || numero > 505) {
        JOptionPane.showMessageDialog(this, 
            "El número debe estar entre 101 y 505 (piso 1 a 5).", 
            "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    int piso = numero / 100;      
    int cuarto = numero % 100;

    if (piso < 1 || piso > 5 || cuarto < 1 || cuarto > 5) {
        JOptionPane.showMessageDialog(this, 
            "Formato inválido. Cada piso (1-5) solo tiene habitaciones 01 a 05.\n", 
            "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    if (hotel.getInventario().buscarHabitacion(numero) != null) {
        JOptionPane.showMessageDialog(this, 
    ...
    hotel.getInventario().registrarHabitacion(nueva);

    JOptionPane.showMessageDialog(this, 
        "Habitación añadida exitosamente.", 
