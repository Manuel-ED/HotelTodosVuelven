...
public class Habitaciones extends javax.swing.JFrame {
    ...
    private void cargarTablaHabitaciones() {
        ...
        ListaEnlazada<Habitacion> lista = hotel.getInventario().obtenerTodasLasHabitaciones();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("00000000000");

        jLabel7.setText("0000000000");

        jLabel8.setText("0000000000");
    ...
    String texto = jTextField1.getText();
        ...
        Habitacion h = hotel.getInventario().buscarHabitacion(num);
    ...
    if (!estado.equalsIgnoreCase("Libre") && !estado.equalsIgnoreCase("Limpieza")) {
        JOptionPane.showMessageDialog(this,
            "Estado inválido. Solo se permite 'Libre' o 'Limpieza'.",
            "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    if (estado.equalsIgnoreCase("libre")) estado = "Libre";
    if (estado.equalsIgnoreCase("limpieza")) estado = "Limpieza";

    hotel.getInventario().actualizarEstado(num, estado);
