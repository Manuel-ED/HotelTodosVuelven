...
public class RegistrarNuevoCliente extends javax.swing.JFrame {
    ...
    private Hotel hotel;
    private boolean enviarARecepcion;
    private Cliente clienteCreado;

    public RegistrarNuevoCliente(Hotel hotel, boolean enviarARecepcion) {
        initComponents();
        this.hotel = hotel;
        this.enviarARecepcion = enviarARecepcion;
    ...
    if (!Validador.validarTelefono(telefono)) {
        JOptionPane.showMessageDialog(this, "Error: El Teléfono es obligatorio y el formato es inválido.", "Validación", JOptionPane.WARNING_MESSAGE);
    ...
    try {
        if (hotel.buscarCliente(dni) != null) {
            JOptionPane.showMessageDialog(this,
                "Error: El cliente con DNI " + dni + " ya está registrado.",
        ...
        JOptionPane.showMessageDialog(this,
            "Ocurrió un error al registrar el cliente: " + e.getMessage(),
